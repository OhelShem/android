...
import com.ohelshem.app.controller.OffsetDataController
import com.ohelshem.app.controller.OffsetDataControllerImpl
import com.ohelshem.getTestResource
...
class OffsetDataControllerTest {
    ...
    fun testReadSpecific() {
        val data = controller.read(OffsetFile, DataFile, 12 + 12 + (4 - 1)).map { it.trim() }.normalize()
        val supposedData = "timetable_11_4_data.dsv".getTestResource().readLines().map { it.trim() }
