...
interface TimetableController {
    ...
    companion object {
        ...
        val Holidays = arrayOf(
                Holiday("ראש השנה", "29/09/2019", "01/10/2019"),
                Holiday("יום כיפור", "08/10/2019", "09/10/2019"),
                Holiday("סוכות", "13/10/2019", "22/10/2019"),
                Holiday("חנוכה", "24/12/2019", "30/12/2019"),
                Holiday("פורים", "09/03/2020", "11/03/2020"),
                Holiday("פסח", "31/03/2020", "16/04/2020"),
                Holiday("יום העצמאות", "29/04/2020"),
                Holiday("ל\"ג בעומר", "12/05/2020"),
                Holiday("שבועות", "28/05/2020", "30/05/2020"))
