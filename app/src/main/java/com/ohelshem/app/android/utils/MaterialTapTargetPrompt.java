...
public class MaterialTapTargetPrompt {
    ...
    public static class Builder {
        ...
        public Builder(final Activity activity, int themeResId) {
            ...
            mIconDrawableTintList = a.getColorStateList(R.styleable.PromptView_mt_iconTint);
            mIconDrawableTintMode = parseTintMode(a.getInt(R.styleable.PromptView_mt_iconTintMode, -1), PorterDuff.Mode.MULTIPLY);
